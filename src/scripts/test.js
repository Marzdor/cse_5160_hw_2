...
const Plot = ({ x, y }) => (
  <svg width="100" height="100">
    <line x1="0" y1={100 - hypothesis(0)} x2="100" y2={100 - hypothesis(100)} />

    {DATA.map((date, key) => (
      <circle key={key} cx={date[x]} cy={100 - date[y]} />
    ))}
  </svg>
);
...
const Hypothesis = () => (
  <p>
    <strong>Hypothesis:</strong> f(x) = {thetaZero.toFixed(2)} +{" "}
    {thetaOne.toFixed(2)}x
  </p>
);
